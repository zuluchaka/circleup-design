...
export type PlatformRole = 'platform_member' | 'platform_admin'
...
export interface LoginPageProps {
  ...
  onLogin?: (email: string, password: string, rememberMe: boolean) => void | Promise<{ success: boolean; error?: string }>
...
export interface ResetPasswordPageProps {
  ...
  onSubmit?: (newPassword: string) => Promise<{ success: boolean; error?: string }> | void
...
export interface OnboardingWizardProps {
  ...
  onStepComplete?: (stepId: string, value: string) => Promise<{ success: boolean; error?: string }> | void
  /** Called when user skips the wizard */
  onSkip?: () => void
  /** Called when user finishes all steps */
  onComplete?: () => Promise<{ success: boolean; error?: string }> | void
}
