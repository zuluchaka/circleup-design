...
import type { BadgeGalleryProps, Badge, UserBadge, BadgeProgress, BadgeTier, BadgeCategory } from '@/../product/sections/community-and-social/types'
...
function EarnedBadgeCard({ userBadge, badge: _badge, onShare, onView }: EarnedBadgeCardProps) {
