import type { Association, Member, PendingInvitation, JoinRequest, FederationMembership } from '@/../product/sections/associations/types'
...
export function AssociationAdministration({
  ...
  const isAdmin = association.myRole === 'president' || association.myRole === 'organizer' || association.myRole === 'treasurer'
