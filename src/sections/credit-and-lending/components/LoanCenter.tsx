...
import type { Loan, ScheduledPayment, Guarantor, CircleBacking } from '@/../product/sections/credit-and-lending/types'
...
function LoanCard({
  ...
  onRequestRestructuring: _onRequestRestructuring,
  onRefinance,
}: {
  loan: Loan
  scheduledPayments: ScheduledPayment[]
