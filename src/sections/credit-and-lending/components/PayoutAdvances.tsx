...
import { Zap, Calendar, CheckCircle, Clock, AlertCircle, ChevronRight } from 'lucide-react'
import type { PayoutAdvance, UpcomingPayout, PaymentMethod } from '@/../product/sections/credit-and-lending/types'
