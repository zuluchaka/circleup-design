...
import type { PositionSwapProps, SwapRequestStatus } from '@/../product/sections/rosca-circles/types'
            ...
            <div className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-full bg-indigo-100 dark:bg-indigo-900/40 flex items-center justify-center">
                <span className="text-2xl font-bold text-indigo-600 dark:text-indigo-400">
                  #{currentParticipant.payoutPosition || (currentParticipant.role === 'organizer' ? '1' : '?')}
                </span>
              </div>
              <div>
                <p className="font-medium text-slate-900 dark:text-white">
                  {currentParticipant.payoutReceived ? (
                    ...
                    `Payout Position ${currentParticipant.payoutPosition || (currentParticipant.role === 'organizer' ? '1' : 'TBD')}`
                  )}
                </p>
