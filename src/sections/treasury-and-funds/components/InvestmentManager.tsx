...
import type { InvestmentManagerProps, Investment, InvestmentInstrument, RiskLevel } from '@/../product/sections/treasury-and-funds/types'
...
export function InvestmentManager({
  ...
  onAllocate,
  onWithdraw,
  onAdjustAllocation: _onAdjustAllocation,
