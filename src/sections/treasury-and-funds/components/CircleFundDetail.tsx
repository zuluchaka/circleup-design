...
import type { CircleFundDetailProps, Transaction, TransactionType, TransactionStatus, ReportFormat } from '@/../product/sections/treasury-and-funds/types'
...
export function CircleFundDetail({
  fund,
  transactions,
  onFilterTransactions: _onFilterTransactions,
  onExportStatement,
  onBack,
