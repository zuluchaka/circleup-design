import type { CircleHealthDashboardProps, MemberContribution } from '@/../product/sections/analytics-and-reporting/types'
import {
  TrendingUp,
  TrendingDown,
  Minus,
...
export function CircleHealthDashboard({
  ...
  const completedCycles = Math.max(0, metrics.currentCycle - 1)
  const progress = (completedCycles / metrics.totalCycles) * 100
