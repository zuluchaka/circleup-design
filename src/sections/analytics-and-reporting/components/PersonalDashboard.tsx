import type { PersonalDashboardProps, CircleParticipation, AIInsight } from '@/../product/sections/analytics-and-reporting/types'
import {
  TrendingUp,
  TrendingDown,
  Minus,
...
function CircleCard({
  ...
  const progress = (completedCycles / circle.totalCycles) * 100
