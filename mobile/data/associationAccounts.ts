...
const ACCOUNTS: AssociationAccount[] = [
  ...
  // Variant fixtures (used by edge-state screenshot routes; not surfaced in
  // production listings).
  {
    id: "aa-froz-001",
    accountNumber: "ASS-FROZ-PRI",
    associationId: "as-froz",
    associationName: "Eritrean Cultural Forum · Bern",
    accountType: "primary",
    currency: "CHF",
    balance: 4280,
    status: "frozen",
    ...
    recentEntries: [
      {
        ...
        amount: 0,
        currency: "CHF",
        description: "Account frozen by platform admin — KYC review pending",
        runningBalance: 4280,
        postedAt: "2026-05-12T10:00:00Z",
        recordedByName: "Mafao Compliance",
      },
    ],
  ...
  {
    id: "aa-empty-001",
    accountNumber: "ASS-NEW1-PRI",
    associationId: "as-new1",
    associationName: "Tamil Diaspora Association · Lausanne",
    accountType: "primary",
    currency: "CHF",
    balance: 0,
    status: "active",
