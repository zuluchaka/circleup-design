# Test Instructions: Communication & Events
...
### Flow 1: View unified inbox

**Scenario:** User wants to view unified inbox
...
**Scenario:** User wants to send a message
...
### Flow 3: Create announcement

**Scenario:** User wants to create announcement
...
### Flow 4: Create event with registration

**Scenario:** User wants to create event with registration
...
### Flow 5: Configure notification preferences

**Scenario:** User wants to configure notification preferences
...
**Scenario:** No messages yet — show welcome message
...
**Scenario:** Event with no registrations, inbox with no notifications
