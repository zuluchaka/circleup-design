# Test Instructions: Projects & Fundraising
...
### Flow 1: Browse campaigns

**Scenario:** User wants to browse campaigns
...
### Flow 2: Make a donation

**Scenario:** User wants to make a donation
...
### Flow 4: Manage donors

**Scenario:** User wants to manage donors
...
**Scenario:** No campaigns yet — show 'Create Campaign' CTA
...
**Scenario:** Campaign with no donations, no donors
