...
### Flow 1: Browse document library

**Scenario:** User wants to browse document library
...
### Flow 2: Upload a document

**Scenario:** User wants to upload a document
...
### Flow 3: View document preview

**Scenario:** User wants to view document preview
...
### Flow 4: Sign membership agreement

**Scenario:** User wants to sign membership agreement
...
### Flow 5: Use document template

**Scenario:** User wants to use document template
...
**Scenario:** No documents yet — show 'Upload Document' CTA
...
**Scenario:** Circle with no documents, empty folder
