...
**Scenario:** User wants to register with email
...
### Flow 2: Register with social (Google/Apple)

**Scenario:** User wants to register with social (google/apple)
...
### Flow 3: Login with credentials

**Scenario:** User wants to login with credentials
...
**Scenario:** User wants to reset forgotten password
...
### Flow 5: Complete email verification

**Scenario:** User wants to complete email verification
...
### Flow 6: Complete onboarding wizard

**Scenario:** User wants to complete onboarding wizard
...
**Scenario:** N/A (auth pages are forms)
