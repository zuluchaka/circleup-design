      ...
      <div className="w-full max-w-[520px]">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 py-3 text-sm font-medium text-slate-600 dark:text-slate-400 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-750 transition-all"
          >
            Skip
          </button>
          <button
            onClick={handleNext}
            disabled={!step || !values[step.id]}
            className="flex-[2] py-3 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold rounded-xl transition-all active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed shadow-sm shadow-indigo-600/25"
          >
