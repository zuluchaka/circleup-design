...
### Flow 1: View AI insights dashboard

**Scenario:** User wants to view ai insights dashboard
...
### Flow 2: Chat with AI financial assistant

**Scenario:** User wants to chat with ai financial assistant
...
### Flow 3: Monitor default risk (organizer)

**Scenario:** User wants to monitor default risk (organizer)
...
### Flow 4: Review fraud alerts (admin)

**Scenario:** User wants to review fraud alerts (admin)
...
### Flow 5: Explore trust network

**Scenario:** User wants to explore trust network
...
**Scenario:** No insights yet — AI needs participation data to generate recommendations
...
**Scenario:** No chat history, no fraud alerts
