# Test Instructions: Analytics & Reporting
...
### Flow 1: View personal savings dashboard

**Scenario:** User wants to view personal savings dashboard
...
### Flow 2: Monitor circle health (organizer)

**Scenario:** User wants to monitor circle health (organizer)
...
### Flow 3: Generate and download statement

**Scenario:** User wants to generate and download statement
...
### Flow 4: Create and track savings goal

**Scenario:** User wants to create and track savings goal
...
**Scenario:** No analytics data yet — appears after circle participation
...
**Scenario:** Dashboard with no savings goals, no generated reports
