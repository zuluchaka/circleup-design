...
### Flow 1: Create federation

**Scenario:** User wants to create federation
...
### Flow 2: Link child associations

**Scenario:** User wants to link child associations
...
### Flow 3: Configure policies

**Scenario:** User wants to configure policies
...
### Flow 4: View financial dashboard

**Scenario:** User wants to view financial dashboard
...
### Flow 5: Run federation election

**Scenario:** User wants to run federation election
...
### Flow 6: Manage cross-association members

**Scenario:** User wants to manage cross-association members
...
**Scenario:** No federations yet — show 'Create Federation' CTA
...
**Scenario:** Federation with no child associations, no policies
