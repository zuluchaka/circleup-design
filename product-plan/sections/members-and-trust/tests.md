# Test Instructions: Members & Trust
...
### Flow 1: Browse and search member directory

**Scenario:** User wants to browse and search member directory
...
### Flow 2: View member profile with trust score

**Scenario:** User wants to view member profile with trust score
...
### Flow 3: View own trust score with improvement tips

**Scenario:** User wants to view own trust score with improvement tips
...
### Flow 4: Review at-risk members (organizer)

**Scenario:** User wants to review at-risk members (organizer)
...
**Scenario:** No members yet — show invitation CTA
...
**Scenario:** Member with no references, no feedback
