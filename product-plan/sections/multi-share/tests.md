...
### Flow 1: Request additional shares

**Scenario:** User wants to request additional shares
...
### Flow 2: View share distribution

**Scenario:** User wants to view share distribution
...
### Flow 3: Make multi-share contribution

**Scenario:** User wants to make multi-share contribution
...
### Flow 4: Approve share request (organizer)

**Scenario:** User wants to approve share request (organizer)
...
### Flow 5: Monitor compliance (admin)

**Scenario:** User wants to monitor compliance (admin)
...
**Scenario:** No multi-share circles — feature activates when circle enables multi-share
...
**Scenario:** Circle with no share requests, no compliance alerts
