# Test Instructions: Associations
...
### Flow 1: View my associations list

**Scenario:** User wants to view my associations list
...
### Flow 2: Create new association

**Scenario:** User wants to create new association
...
### Flow 3: Discover and join associations

**Scenario:** User wants to discover and join associations
...
### Flow 4: Manage association settings and members

**Scenario:** User wants to manage association settings and members
...
### Flow 5: Import existing association via migration wizard

**Scenario:** User wants to import existing association via migration wizard
...
**Scenario:** No associations yet — show 'Create your first association' CTA
...
**Scenario:** Association with no members, no activity
