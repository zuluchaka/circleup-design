...
export type MemberRole = 'president' | 'treasurer' | 'secretary' | 'admin' | 'member'
...
export type ActivityType = 'member_joined' | 'announcement_posted' | 'circle_created' | 'payout_completed' | 'role_changed'
