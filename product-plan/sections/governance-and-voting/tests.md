# Test Instructions: Governance & Voting
...
### Flow 1: Create and run an election

**Scenario:** User wants to create and run an election
...
### Flow 2: Submit and vote on a proposal

**Scenario:** User wants to submit and vote on a proposal
...
### Flow 3: Cast ballot in voting booth

**Scenario:** User wants to cast ballot in voting booth
...
### Flow 4: Configure governance rules

**Scenario:** User wants to configure governance rules
...
### Flow 5: Join a committee

**Scenario:** User wants to join a committee
...
**Scenario:** No active elections or proposals — show 'Create Election' or 'Submit Proposal' CTAs
...
**Scenario:** Election with no candidates, proposal with no votes
